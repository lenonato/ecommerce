                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Para redefinir a sua senha acesse o link abaixo. <a href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?></a>.
                            </td>
                          </tr>
                        </table>
                        <div><!--[if mso]>
